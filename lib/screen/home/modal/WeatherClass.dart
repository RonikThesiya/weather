/// coord : {"lon":73.1812,"lat":22.3072}
/// weather : [{"id":801,"main":"Clouds","description":"few clouds","icon":"02d"}]
/// base : "stations"
/// main : {"temp":308.15,"feels_like":311.31,"temp_min":308.15,"temp_max":308.15,"pressure":1008,"humidity":43}
/// visibility : 6000
/// wind : {"speed":2.57,"deg":20}
/// clouds : {"all":20}
/// dt : 1666093781
/// sys : {"type":1,"id":9060,"country":"IN","sunrise":1666055068,"sunset":1666096812}
/// timezone : 19800
/// id : 1253573
/// name : "Vadodara"
/// cod : 200
...
class WeatherClass {
  ...
  WeatherClass.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
WeatherClass copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => WeatherClass(  coord: coord ?? _coord,
